...
#define _DIST_MIN 175.0   // minimum distance to be measured (unit: mm)
#define _DIST_MAX 365.0   // maximum distance to be measured (unit: mm)
...
void loop() {
  ...
  duty_live = _DUTY_MIN + ((dist_ema - _TARGET_LOW)*10);
  ...
  if (dist_raw < _TARGET_LOW) {
    ...
    myservo.writeMicroseconds(duty_live);
